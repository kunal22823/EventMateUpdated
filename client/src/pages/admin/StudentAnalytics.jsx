...
export default function StudentAnalytics() {
  ...
  const totalRegistrations = filteredStudents.reduce(
    (sum, s) => sum + s.totalRegistrations,
    0,
  );
  const totalAttended = filteredStudents.reduce(
    (sum, s) => sum + s.totalAttended,
    0,
  );
  const avgAttendanceRate =
    totalAttended > 0
      ...
      : 0;
  const totalCredits = filteredStudents.reduce(
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">
          Comprehensive student participation metrics
        </p>
      </div>

      {/* Filters */}
      <div className="card p-6 flex gap-6 flex-wrap">
        <div className="flex-1 min-w-[180px] max-w-[220px]">
          ...
          <select
            ...
            className="w-full px-7 py-6 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          >
      ...
      {performerChartData.length > 0 && (
        <div className="card p-6">
          <h3 className="text-base font-semibold text-slate-900 mb-4">
            Top 10 Performers by Attendance
          </h3>
            ...
            <tbody className="divide-y divide-slate-200">
              {filteredStudents.map((student) => (
                ...
                >
                  ...
                  <td className="px-6 py-3 text-sm text-slate-600 text-right font-semibold">
